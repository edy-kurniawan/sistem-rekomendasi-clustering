    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Silahkan masuk Admin</h3>
            </div>
            <div class="panel-body">
                <form class="form-signin" action="?act=login" method="post">                        
                <?php if( $_POST ) include'aksi.php' ?>
                <div class="form-group">
                    <input type="text" class="form-control input-lg" placeholder="Username" name="user" autofocus />
                </div>
                <div class="form-group">
            ...
            <div class="card-footer bg-white p-0  ">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="login_user.php" class="footer-link">Masuk Sebagai User</a></div>  
            </div>
            </div>
        </div> 
    </div>    
